...
export interface ApiAccessoryAccessory extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    banner_images: Schema.Attribute.JSON;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiCatSchCatSch extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    equipment: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<false>;
    exer_count: Schema.Attribute.Integer;
    exercises: Schema.Attribute.Relation<
      'manyToMany',
      'api::exercise.exercise'
    >;
...
export interface ApiCategoryCategory extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    cat_sches: Schema.Attribute.Relation<'manyToMany', 'api::cat-sch.cat-sch'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    image_url: Schema.Attribute.String;
...
export interface ApiDailyQuoteDailyQuote extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    quote: Schema.Attribute.JSON & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiDashboardItemDashboardItem
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    prefer: Schema.Attribute.Decimal &
      Schema.Attribute.Required &
...
export interface ApiExerciseExercise extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    accessories: Schema.Attribute.Relation<
      ...
      'api::accessory.accessory'
    >;
    banner_image_urls: Schema.Attribute.JSON;
    cat_sch: Schema.Attribute.Relation<'manyToMany', 'api::cat-sch.cat-sch'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    dashboard_item: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<false>;
    description: Schema.Attribute.Text;
    details: Schema.Attribute.JSON;
    difficulty: Schema.Attribute.Decimal &
    ...
    > &
      Schema.Attribute.Private;
    muscle: Schema.Attribute.Relation<'oneToOne', 'api::muscle.muscle'>;
    publishedAt: Schema.Attribute.DateTime;
    rest_time: Schema.Attribute.Integer;
    time: Schema.Attribute.Float;
    title: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiMuscleMuscle extends Struct.CollectionTypeSchema {
...
export interface ApiSubscriptionPlanSubscriptionPlan
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.String;
    discount: Schema.Attribute.Float;
    gplan_id: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    usertype: Schema.Attribute.Enumeration<
      ['STARTER', 'CUSTOMER', 'POTENTIAL_USER']
    >;
  };
}
...
export interface ApiSubscriptionSubscription
  ...
  attributes: {
    ...
    expire_time: Schema.Attribute.DateTime & Schema.Attribute.Required;
    last_order_id: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiUserCatSchUserCatSch extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.Text;
    equipment: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    exer_count: Schema.Attribute.Integer;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    user: Schema.Attribute.Relation<
      ...
      'plugin::users-permissions.user'
    >;
    user_exercises: Schema.Attribute.Relation<
      'manyToMany',
      'api::user-exercise.user-exercise'
    >;
    user_workoutplans: Schema.Attribute.Relation<
      'manyToMany',
...
export interface ApiUserExerciseUserExercise
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    user: Schema.Attribute.Relation<
      ...
      'plugin::users-permissions.user'
    >;
    user_cat_sches: Schema.Attribute.Relation<
      'manyToMany',
      'api::user-cat-sch.user-cat-sch'
    >;
  };
...
export interface ApiWalletWallet extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    coins: Schema.Attribute.BigInteger;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    subscribed: Schema.Attribute.Boolean &
      ...
      Schema.Attribute.Private &
      Schema.Attribute.DefaultTo<false>;
    subscriber: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
      Schema.Attribute.Private &
      Schema.Attribute.DefaultTo<false>;
    subscription_expire_time: Schema.Attribute.DateTime &
      Schema.Attribute.Private;
